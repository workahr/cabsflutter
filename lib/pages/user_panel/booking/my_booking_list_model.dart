...
// BookingListData bookingListDataFromJson(String str) => BookingListData.fromJson(json.decode(str));

// String bookingListDataToJson(BookingListData data) => json.encode(data.toJson());
...
//         status: json["status"],
//         list: List<BookingList>.from(json["list"].map((x) => BookingList.fromJson(x))),
//         code: json["code"],
